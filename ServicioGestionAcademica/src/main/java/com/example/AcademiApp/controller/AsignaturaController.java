...
public class AsignaturaController {
   ...
   @PutMapping("/{id}")
   public ResponseEntity<?> actualizar(@PathVariable int id, @RequestBody AsignaturaRequest request) {
      try {
         Asignatura asignaturaActualizada = asignaturaService.actualizarAsignatura(id, request);
